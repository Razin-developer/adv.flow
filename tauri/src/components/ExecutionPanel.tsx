...
export default function ExecutionPanel({ workflowId, onBeforeRun, workflowKind }: ExecutionPanelProps) {
    ...
    <section className="execution-panel">
      <div className="panel-header">
        <div>
          ...
          <p>
            {workflowKind === 'inApp'
              ? 'This workflow runs from its in-app hotkey when the selected app is focused.'
              : running
                ? 'Workflow is running.'
                : done
        ...
        <div className="execution-actions">
          ...
          {workflowKind === 'inApp' ? null : running ? (
